...
const QuestionsForm = () => {
  ...
  return (
    <div className="main main--questionsForm">
      ...
      <div className="main__content">
        <div className="content__questionBox">
          {qAA.map(qaa => (
            <div key={qaa.id}>
              <div className="questionBox__question" onClick={() => handleClick(qaa)}>
                <p>
                  <QuestionSign className="question__sign"  visibility={qaa.visibility} />
                  <span className="question__text">{qaa.question}</span>
                </p>
              </div>
                <Answer key={qaa.id} visibility={qaa.visibility} answer={qaa.answer} />
            </div>
          ))}
        </div>
      </div>
